            ...
            <Grid size={12}>
              ...
              >
                ...
                <Box sx={{ flex: 1, height: '100%', display: 'flex', flexDirection: 'column', pr: 2, py: 1, overflow: 'hidden' }}>
                  ...
                  >
                    {visualizations[currentView].description
                      ...
                      if (subtitleMatch) {
                        ...
                        return (
                          <Box key={index} sx={{ display: 'flex', flexDirection: 'column', gap: 0.2, mt: index > 0 ? 2 : 0 }}>
                            <Typography
                              color="#000"
                              sx={{
                                lineHeight: 1.35,
                            ...
                            <Typography
                              color="#000"
                              sx={{ lineHeight: 1.55, fontSize: '1em', pl: 1.9, whiteSpace: 'pre-line' }}
                            >
                              {body}
                            </Typography>
                          </Box>
