...
const NetworkDataFusion = ({ open = true, isPopup = false }) => {
  ...
  return <ConsoleView key={consoleKey} type="networkDataFusion" open={isRunning} isPopup={isPopup} controls={controls} />;
};
